...
#define RAW_INT0		GPIO(58)
#define AP2MDM_PON_RESET_N	GPIO(59)

#define APQ2MDM_IPC2		GPIO(60)
#define QSC2AP_STATUS		GPIO(61)
...
#define AUD_HP_EN		PM8921_GPIO_PM_TO_SYS(10)
...
extern struct pm8xxx_regulator_platform_data
	m7china_pm8921_regulator_pdata[] __devinitdata;

extern int m7china_pm8921_regulator_pdata_len __devinitdata;
...
extern struct gpio_regulator_platform_data
	m7china_gpio_regulator_pdata[] __devinitdata;

extern struct rpm_regulator_platform_data
	m7china_rpm_regulator_pdata __devinitdata;

extern struct regulator_init_data m7china_saw_regulator_pdata_8921_s5;
extern struct regulator_init_data m7china_saw_regulator_pdata_8921_s6;
extern struct regulator_init_data m7china_saw_regulator_pdata_8821_s0;
extern struct regulator_init_data m7china_saw_regulator_pdata_8821_s1;

struct mmc_platform_data;
int __init apq8064_add_sdcc(unsigned int controller,
		struct mmc_platform_data *plat);

void m7china_init_mmc(void);
int m7china_wifi_init(void);
void m7china_init_gpiomux(void);
void m7c_init_pmic(void);
/* HTC_START - for HW VCM work-around */
void m7c_init_pmic_register_cam_cb(void *cam_vcm_on_cb, void *cam_vcm_off_cb);
/* HTC_END */
...
void m7china_init_fb(void);
void m7china_allocate_fb_region(void);
void m7china_mdp_writeback(struct memtype_reserve *reserve_table);

void m7china_init_gpu(void);
void m7c_pm8xxx_gpio_mpp_init(void);
void m7china_usb_uart_switch(int nvbus);
