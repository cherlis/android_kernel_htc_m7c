...
static struct mmc_platform_data *m7china_sdc1_pdata = &sdc1_data;
#else
static struct mmc_platform_data *m7china_sdc1_pdata;
#endif
...
static unsigned int m7china_sdc3_slot_type = MMC_TYPE_SD;
static struct mmc_platform_data sdc3_data = {
	.ocr_mask       = MMC_VDD_27_28 | MMC_VDD_28_29,
	.mmc_bus_width  = MMC_CAP_4_BIT_DATA,
	.sup_clk_table	= sdc3_sup_clk_rates,
	.sup_clk_cnt	= ARRAY_SIZE(sdc3_sup_clk_rates),
	.slot_type      = &m7china_sdc3_slot_type,
	.pin_data	= &mmc_slot_pin_data[SDCC3],
	.vreg_data	= &mmc_slot_vreg_data[SDCC3],
	.status_gpio	= PM8921_GPIO_PM_TO_SYS(SDC3_CD),
	.status_irq	= PM8921_GPIO_IRQ(PM8921_IRQ_BASE, SDC3_CD),
...
static struct mmc_platform_data *m7china_sdc3_pdata = &sdc3_data;
#else
static struct mmc_platform_data *m7china_sdc3_pdata;
#endif
#endif
...
static int
m7china_wifi_status_register(void (*callback)(int card_present, void *dev_id),
				void *dev_id)
{
	if (wifi_status_cb)
		return -EAGAIN;
...
{
	return m7china_wifi_cd;
}

static unsigned int m7china_wifislot_type = MMC_TYPE_SDIO_WIFI;
static unsigned int wifi_sup_clk_rates[] = {
	400000, 24000000, 48000000, 96000000
};
static struct mmc_platform_data m7china_wifi_data = {
	.ocr_mask               = MMC_VDD_28_29,
	.status                 = m7china_wifi_status,
	.register_status_notify = m7china_wifi_status_register,
	.embedded_sdio          = &m7china_wifi_emb_data,
	.mmc_bus_width  = MMC_CAP_4_BIT_DATA,
	.slot_type = &m7china_wifislot_type,
...
int m7china_wifi_set_carddetect(int val)
{
...
#if 0
int m7china_wifi_power(int on)
{
	return 0;
}
EXPORT_SYMBOL(m7china_wifi_power);

int m7china_wifi_reset(int on)
{
