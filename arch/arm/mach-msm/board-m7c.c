...
static struct tpa6185_platform_data tpa6185_data={
         .gpio_tpa6185_spk_en = AUD_HP_EN,

};

static struct rt5501_platform_data rt5501_data={
         .gpio_rt5501_spk_en = AUD_HP_EN,
...
static struct platform_device m7c_android_pmem_device = {
	.name = "android_pmem",
	.id = 0,
...
static struct platform_device m7c_android_pmem_adsp_device = {
	.name = "android_pmem",
	.id = 2,
	.dev = { .platform_data = &android_pmem_adsp_pdata },
};

static struct android_pmem_platform_data m7c_android_pmem_audio_pdata = {
	.name = "pmem_audio",
	.allocator_type = PMEM_ALLOCATORTYPE_BITMAP,
	.cached = 0,
	.memory_type = MEMTYPE_EBI1,
...
static struct msm_rtb_platform_data m7c_rtb_pdata = {
...
static int __init msm_rtb_set_buffer_size(char *p)
{
       ...
       s = memparse(p, NULL);
       m7c_rtb_pdata.size = ALIGN(s, SZ_4K);
       return 0;
}
early_param("msm_rtb_size", msm_rtb_set_buffer_size);


static struct platform_device m7c_rtb_device = {
       .name           = "msm_rtb",
       .id             = -1,
       .dev            = {
               .platform_data = &m7c_rtb_pdata,
       },
};
#endif
...
static int m7c_paddr_to_memtype(unsigned int paddr)
{
	return MEMTYPE_EBI1;
}
...
#ifdef CONFIG_MSM_MULTIMEDIA_USE_ION
static struct ion_cp_heap_pdata cp_mm_m7c_ion_pdata = {
...
static struct ion_cp_heap_pdata cp_mfc_m7c_ion_pdata = {
...
static struct ion_co_heap_pdata co_m7c_ion_pdata = {
	.adjacent_mem_id = INVALID_HEAP_ID,
	.align = PAGE_SIZE,
	.mem_is_fmem = 0,
};

static struct ion_co_heap_pdata fw_co_m7c_ion_pdata = {
...
static struct ion_platform_data ion_pdata = {
	...
	.heaps = {
...
#ifdef CONFIG_MSM_MULTIMEDIA_USE_ION
		{
			...
			.extra_data = (void *) &cp_mm_m7c_ion_pdata,
		},
		{
			...
			.memory_type = ION_EBI_TYPE,
			.extra_data = (void *) &fw_co_m7c_ion_pdata,
		},
		{
			...
			.memory_type = ION_EBI_TYPE,
			.extra_data = (void *) &cp_mfc_m7c_ion_pdata,
		},
#ifndef CONFIG_MSM_IOMMU
		{
			...
			.memory_type = ION_EBI_TYPE,
			.extra_data = (void *) &co_m7c_ion_pdata,
		},
#endif
		{
...
static struct platform_device m7c_ion_dev = {
	.name = "ion-msm",
	.id = 1,
...
uint32_t apq_mdm_gpio_setting_table[] = {
        GPIO_CFG(MDM2AP_HSIC_READY,  0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
        GPIO_CFG(MDM2AP_ERR_FATAL,  0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
        ...
        GPIO_CFG(MDM2AP_VDDMIN,  0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
};
...
uint32_t apq_qsc_gpio_setting_table[] = {
        GPIO_CFG(QSC2AP_ERR_FATAL,  0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
        GPIO_CFG(QSC2AP_STATUS,  0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
};

static struct resource dsda_qsc_resources[] = {
	{
		.start	= QSC2AP_ERR_FATAL,
		.end	= QSC2AP_ERR_FATAL,
		.name	= "MDM2AP_ERRFATAL",
		.flags	= IORESOURCE_IO,
	},
	{
		.start	= AP2QSC_ERR_FATAL,
		.end	= AP2QSC_ERR_FATAL,
		.name	= "AP2MDM_ERRFATAL",
		.flags	= IORESOURCE_IO,
	},
	{
...
static struct platform_device dsda_qsc_8064_device = {
	.name		= "qsc_modem",
	.id		= -1,
...
{
	m7china_mdp_writeback(apq8064_reserve_table);
}

static void __init m7c_calculate_reserve_sizes(void)
{
	size_pmem_devices();
	reserve_pmem_memory();
	reserve_ion_memory();
...
static struct reserve_info m7c_reserve_info __initdata = {
	.memtype_reserve_table = apq8064_reserve_table,
	.calculate_reserve_sizes = m7c_calculate_reserve_sizes,
	.reserve_fixed_area = apq8064_reserve_fixed_area,
	.paddr_to_memtype = m7c_paddr_to_memtype,
};

static int m7c_memory_bank_size(void)
{
	return 1<<29;
}
...
static void __init locate_unstable_memory(void)
{
	...
	bank_size = m7c_memory_bank_size();
	...
	m7c_reserve_info.low_unstable_address = mb->start -
					MIN_MEMORY_BLOCK_SIZE + mb->size;
	m7c_reserve_info.max_unstable_size = MIN_MEMORY_BLOCK_SIZE;

	m7c_reserve_info.bank_size = bank_size;
	pr_info("low unstable address %lx max size %lx bank size %lx\n",
		m7c_reserve_info.low_unstable_address,
		m7c_reserve_info.max_unstable_size,
		m7c_reserve_info.bank_size);
	return;
#endif
no_dmm:
	m7c_reserve_info.low_unstable_address = high;
	m7c_reserve_info.max_unstable_size = 0;
}

int __init parse_tag_memsize(const struct tag *tags);
static unsigned int mem_size_mb;

static void __init m7c_reserve(void)
{
	if (mem_size_mb == 64)
		return;
...
static struct pm8xxx_gpio_init switch_to_usb_pmic_gpio_table[] = {
        PM8XXX_GPIO_INIT(MHL_USB_SW, PM_GPIO_DIR_OUT,
...
static void m7c_usb_dpdn_switch(int path)
{
	switch (path) {
	case PATH_USB:
...
static T_MHL_PLATFORM_DATA mhl_sii9234_device_data = {
	...
	.ci2ca = 0,
#ifdef CONFIG_FB_MSM_HDMI_MHL
	.mhl_usb_switch		= m7c_usb_dpdn_switch,
...
static struct android_usb_platform_data android_usb_pdata = {
	...
	.product_id	= 0x0dd3,
#elseif CONFIG_MACH_M7C_DUG
	.product_id	= 0x0dd2,
#elseif CONFIG_MACH_M7C_DWG
	.product_id	= 0x0dd4,
#endif
	.version	= 0x0100,
	...
	.usb_rmnet_interface = "HSIC:HSIC,HSUART:HSUART",
	.usb_diag_interface = "diag,diag_mdm,diag_qsc",
	.fserial_init_string = "HSIC:modem,HSUART:modem,tty,tty:autobot,tty:serial,tty:autobot,tty:acm",
	.serial_number = "000000000000",
	.match		= qsc_modem_usb_id_match,
	.nluns		= 1,
};
...
static int64_t m7c_get_usbid_adc(void)
{
...
static void m7c_config_usb_id_gpios(bool output)
{
	int rc;
...
static struct cable_detect_platform_data cable_detect_pdata = {
       ...
       .usb_id_pin_gpio        = USB1_HS_ID_GPIO,
       .get_adc_cb             = m7c_get_usbid_adc,
       .config_usb_id_gpios    = m7c_config_usb_id_gpios,
#ifdef CONFIG_FB_MSM_HDMI_MHL
       .mhl_1v2_power = mhl_sii9234_1v2_power,
       .usb_dpdn_switch        = m7c_usb_dpdn_switch,
#endif
};
...
void m7c_cable_detect_register(void)
{
	int rc;
...
void m7c_pm8xxx_adc_device_register(void)
{
	pr_info("%s: Register PM8XXX ADC device. rev: %d\n",
		__func__, system_rev);
	m7c_cable_detect_register();
}

void m7c_add_usb_devices(void)
{
...
static struct wcd9xxx_pdata m7c_tabla_platform_data = {
...
static struct slim_device m7c_slim_tabla = {
	.name = "tabla-slim",
	.e_addr = {0, 1, 0x10, 0, 0x17, 2},
	.dev = {
		.platform_data = &m7c_tabla_platform_data,
	},
};

static struct wcd9xxx_pdata m7c_tabla20_platform_data = {
	.slimbus_slave_device = {
		.name = "tabla-slave",
...
static struct slim_device m7c_slim_tabla20 = {
	.name = "tabla2x-slim",
	.e_addr = {0, 1, 0x60, 0, 0x17, 2},
	.dev = {
		.platform_data = &m7c_tabla20_platform_data,
	},
};

static DEFINE_MUTEX(tp_lock);
static struct regulator *tp_reg_l15;
static struct regulator *tp_reg_l21;
static int synaptics_power_LPM(int on)
{
	...
	if (tp_reg_l21 == NULL) {
		tp_reg_l21 = regulator_get(NULL, "8921_l21_touch");
		if (IS_ERR(tp_reg_l21)) {
			pr_err("[TP] %s: Unable to get '8921_l21_touch' \n", __func__);
			mutex_unlock(&tp_lock);
			return -ENODEV;
		}
	}
	if (on == 1) {
		...
		rc = regulator_set_optimum_mode(tp_reg_l21, 100);
		if (rc < 0)
			pr_err("[TP] %s: enter LPM,set_optimum_mode l21 failed, rc=%d\n", __func__, rc);
...
static struct synaptics_i2c_rmi_platform_data syn_ts_3k_data[] = { 
	{
		...
		.display_height = 1920,
		.gpio_irq = TP_ATTz,
		.gpio_reset = PM8921_GPIO_PM_TO_SYS(TP_RSTz),
...
static struct synaptics_i2c_rmi_platform_data syn_ts_3k_dlx_data[] = { 
	{
		.version = 0x3332,
		.packrat_number = 1293981,
		.abs_x_min = 0,
...
static ssize_t virtual_syn_keys_dlx_show(struct kobject *kobj,
			struct kobj_attribute *attr, char *buf)
{
	return sprintf(buf,
...
static struct kobj_attribute syn_virtual_keys_dlx_attr = {
	.attr = {
		.name = "virtualkeys.synaptics-rmi-touchscreen",
		.mode = S_IRUGO,
	},
	.show = &virtual_syn_keys_dlx_show,
};
...
static struct attribute *properties_dlx_attrs[] = {
	&syn_virtual_keys_dlx_attr.attr,
	NULL
};
...
static struct attribute_group properties_dlx_attr_group = {
	.attrs = properties_dlx_attrs,
};
...
static struct i2c_board_info motion_sensor_gsbi_2_info[] = {
        {
                ...
                .irq = PM8921_GPIO_IRQ(PM8921_IRQ_BASE, G_INT),
        },
        {
...
static void __init m7c_map_io(void)
{
...
static void __init m7c_init_irq(void)
{
...
static struct platform_device msm8064_device_saw_regulator_core0 = {
	...
	.id	= 0,
	.dev	= {
		.platform_data = &m7china_saw_regulator_pdata_8921_s5,
	},
};
...
static struct platform_device msm8064_device_saw_regulator_core1 = {
	...
	.id	= 1,
	.dev	= {
		.platform_data = &m7china_saw_regulator_pdata_8921_s6,
	},
};
...
static struct platform_device msm8064_device_saw_regulator_core2 = {
	...
	.id	= 2,
	.dev	= {
		.platform_data = &m7china_saw_regulator_pdata_8821_s0,
	},
};
...
static struct platform_device msm8064_device_saw_regulator_core3 = {
	...
	.id	= 3,
	.dev	= {
		.platform_data = &m7china_saw_regulator_pdata_8821_s1,
...
static void config_flashlight_gpios(void)
{
	static uint32_t flashlight_gpio_table[] = {
		...
		GPIO_CFG(AP2QSCIPC1, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	};
...
static void __init m7c_init_buses(void)
{
...
static struct platform_device m7china_device_ext_5v_vreg __devinitdata = {
	.name	= GPIO_REGULATOR_DEV_NAME,
	.id	= PM8921_MPP_PM_TO_SYS(7),
	.dev	= {
		.platform_data
			= &m7china_gpio_regulator_pdata[GPIO_VREG_ID_EXT_5V],
	},
};

static struct platform_device m7china_device_ext_mpp8_vreg __devinitdata = {
	.name	= GPIO_REGULATOR_DEV_NAME,
	.id	= PM8921_MPP_PM_TO_SYS(8),
	.dev	= {
		.platform_data
			= &m7china_gpio_regulator_pdata[GPIO_VREG_ID_EXT_MPP8],
	},
};

static struct platform_device m7china_device_ext_ts_sw_vreg __devinitdata = {
	.name	= GPIO_REGULATOR_DEV_NAME,
	.id	= PM8921_GPIO_PM_TO_SYS(23),
	.dev	= {
		.platform_data
			= &m7china_gpio_regulator_pdata[GPIO_VREG_ID_EXT_TS_SW],
	},
};

static struct platform_device m7china_device_rpm_regulator __devinitdata = {
	.name	= "rpm-regulator",
	.id	= -1,
	.dev	= {
		.platform_data = &m7china_rpm_regulator_pdata,
	},
};
...
static mhl_driving_params m7c_driving_params[] = {
...
static struct msm_hdmi_platform_data hdmi_msm_data = {
	...
	.driving_params = m7c_driving_params,
	.dirving_params_count = ARRAY_SIZE(m7c_driving_params),
};
...
static struct platform_device *common_devices[] __initdata = {
	...
	&msm_device_uart_dm4,
#endif
	&m7china_device_ext_5v_vreg,
	&m7china_device_ext_mpp8_vreg,
	&m7china_device_ext_ts_sw_vreg,
...
#ifdef CONFIG_ANDROID_PMEM
#ifndef CONFIG_MSM_MULTIMEDIA_USE_ION
	&m7c_android_pmem_device,
	&m7c_android_pmem_adsp_device,
	&m7c_android_pmem_audio_device,
#endif 
#endif 
#ifdef CONFIG_ION_MSM
	&m7c_ion_dev,
...
#ifdef CONFIG_QSC_MODEM
static int configure_gsbi1_uart_gpios(int on)
{
	int ret = 0, i;
	int uart_gpios[] = {18, 19, 20, 21};
	static int state = -1;

	pr_info("%s(): configuring GPIO to UART %s\n", __func__, on? "ON" : "OFF");

	if( unlikely(state==on) )
	{
		pr_err("QSC UART was config twice.\n");
		return -EPERM;
	}
...
static struct msm_serial_hs_platform_data apq8064_gsbi1_uart_pdata = {
		.gpio_config = configure_gsbi1_uart_gpios,
};
#endif
...
static struct msm_spi_platform_data m7c_qup_spi_gsbi5_pdata = {
...
static struct slim_boardinfo m7c_slim_devices[] = {
	{
		.bus_num = 1,
		.slim_slave = &m7c_slim_tabla,
	},
	{
		.bus_num = 1,
		.slim_slave = &m7c_slim_tabla20,
	},
...
static struct msm_i2c_platform_data m7c_i2c_qup_gsbi3_pdata = {
	.clk_freq = 384000,
	.src_clk_rate = 24000000,
...
static struct msm_i2c_platform_data m7c_i2c_qup_gsbi4_pdata = {
	.clk_freq = 400000,
	.src_clk_rate = 24000000,
	.share_uart_flag = 1,
};

static struct msm_i2c_platform_data m7c_i2c_qup_gsbi7_pdata = {
	.clk_freq = 400000,
	.src_clk_rate = 24000000,
	.share_uart_flag = 1,
};
...
#endif
static struct cir_platform_data m7c_cir_gsbi3_pdata = {
...
static void __init m7c_i2c_init(void)
{
	...
	apq8064_device_qup_i2c_gsbi3.dev.platform_data =
					&m7c_i2c_qup_gsbi3_pdata;
	apq8064_device_qup_i2c_gsbi4.dev.platform_data =
					&m7c_i2c_qup_gsbi4_pdata;
	apq8064_device_qup_i2c_gsbi7.dev.platform_data =
					&m7c_i2c_qup_gsbi7_pdata;
}
...
static void __init m7c_init_dsps(void)
{
...
static int m7c_mpu3050_sensor_power_LPM(int on)
{
	int rc = 0;
...
static struct mpu3050_platform_data mpu3050_data = {
	...
	.power_LPM = m7c_mpu3050_sensor_power_LPM,
};
...
static struct i2c_registry m7c_i2c_devices[] __initdata = {
	{
		I2C_SURF | I2C_FFA,
...
static void __init register_i2c_devices(void)
{
	...
	for (i = 0; i < ARRAY_SIZE(m7c_i2c_devices); ++i) {
		if (m7c_i2c_devices[i].machs & mach_mask) {
			i2c_register_board_info(m7c_i2c_devices[i].bus,
						m7c_i2c_devices[i].info,
						m7c_i2c_devices[i].len);
		}
	}
...
static void __init m7c_receiver_init(void)
{
...
static void __init m7c_cir_init(void)
{
	...
	cir_rst_gpio.config.output_value = 0;
...
static void __init m7c_common_init(void)
{
	int rc = 0;
	...
	m7c_init_pmic_register_cam_cb(&cam_vcm_on_cb, &cam_vcm_off_cb);
	

	if (machine_is_m7_evm()) {
		for (rc = 0; rc < ARRAY_SIZE(msm_i2c_gsbi3_info); rc++) {
			if (!strcmp(msm_i2c_gsbi3_info[rc].type, SYNAPTICS_3200_NAME))
				msm_i2c_gsbi3_info[rc].platform_data = &syn_ts_3k_dlx_data;
		}
		if (board_build_flag() == 1) {
			for (rc = 0; rc < ARRAY_SIZE(syn_ts_3k_dlx_data);  rc++)
				syn_ts_3k_dlx_data[rc].mfg_flag = 1;
		}
	} else {
		if (board_build_flag() == 1) {
...
#endif
#ifdef CONFIG_QSC_MODEM
	apq8064_gsbi1_uart_pdata.wakeup_irq = gpio_to_irq(19); 
	apq8064_device_uart_gsbi1.dev.platform_data = &apq8064_gsbi1_uart_pdata;
#endif
#ifdef CONFIG_HTC_BATT_8960
...
#ifdef CONFIG_QSC_MODEM
	pr_info("%s: Add QSC device\n", __func__);
	config_gpio_table(apq_qsc_gpio_setting_table, ARRAY_SIZE(apq_qsc_gpio_setting_table));
	dsda_qsc_8064_device.dev.platform_data = &dsda_qsc_platform_data;
	platform_device_register(&dsda_qsc_8064_device);
#endif

	platform_device_register(&apq8064_slim_ctrl);
	slim_register_board_info(m7c_slim_devices,
		ARRAY_SIZE(m7c_slim_devices));
	m7c_init_dsps();
	...
	if (properties_kobj) {
		if(machine_is_m7_evm()) {
			rc = sysfs_create_group(properties_kobj, &properties_dlx_attr_group);
			if (!rc)
				for (rc = 0; rc < ARRAY_SIZE(syn_ts_3k_dlx_data); rc++) {
					syn_ts_3k_dlx_data[rc].vk_obj = properties_kobj;
					syn_ts_3k_dlx_data[rc].vk2Use = &syn_virtual_keys_dlx_attr;
				}
		} else {
...
static void __init m7c_allocate_memory_regions(void)
{
	m7china_allocate_fb_region();
}

static void __init m7c_cdp_init(void)
{
...
static void __init m7c_fixup(struct tag *tags, char **cmdline, struct meminfo *mi)
{
...
MACHINE_START(M7C_DWG, "UNKNOWN")
	...
	.map_io = m7c_map_io,
	.reserve = m7c_reserve,
	.init_irq = m7c_init_irq,
	.handle_irq = gic_handle_irq,
	.timer = &msm_timer,
	.init_machine = m7c_cdp_init,
	.init_early = m7c_allocate_memory_regions,
	.init_very_early = m7c_early_reserve,
	.restart = msm_restart,
MACHINE_END
