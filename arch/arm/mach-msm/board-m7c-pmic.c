...
static struct pm8xxx_gpio_init pm8921_dsda_gpios_xb[] __initdata = {
	PM8921_GPIO_OUTPUT(26, 0, HIGH),	
	PM8921_GPIO_OUTPUT(8, 1, HIGH),		
	PM8921_GPIO_OUTPUT(16, 0, HIGH),	
};
#endif
...
static struct pm8xxx_mpp_init pm8xxx_mpps[] __initdata = {
	...
	PM8921_MPP_INIT(12, D_OUTPUT, PM8921_MPP_DIG_LEVEL_S4, DOUT_CTRL_HIGH),
...
void __init m7c_pm8xxx_gpio_mpp_init(void)
{
	int i, rc;
...
#if 0
if( !is_9kramdump_mode() )
{
	pr_info("%s: Normal boot. Disable QSC PWR\n", __func__);
	if (system_rev < XB) 
	{
		for (i = 0; i < ARRAY_SIZE(pm8921_dsda_gpios); i++) {
			rc = pm8xxx_gpio_config(pm8921_dsda_gpios[i].gpio,
				&pm8921_dsda_gpios[i].config);
			if (rc) {
				pr_err("%s: pm8xxx_gpio_config: rc=%d\n", __func__, rc);
				break;
			}
	...
	{
		for (i = 0; i < ARRAY_SIZE(pm8921_dsda_gpios_xb); i++) {
			rc = pm8xxx_gpio_config(pm8921_dsda_gpios_xb[i].gpio,
				&pm8921_dsda_gpios_xb[i].config);
			if (rc) {
				pr_err("%s: pm8xxx_gpio_config xc: rc=%d\n", __func__, rc);
				break;
			}
		}
	}
...
static struct pm8xxx_pwrkey_platform_data m7c_pm8921_pwrkey_pdata = {
	.pull_up		= 1,
	.kpd_trigger_delay_us	= 15625,
	.wakeup			= 1,
};

static struct pm8xxx_misc_platform_data m7c_pm8921_misc_pdata = {
	.priority		= 0,
};
...
static struct pm8xxx_led_platform_data m7c_pm8921_leds_pdata = {
	.num_leds = ARRAY_SIZE(pm8921_led_info),
	.leds = pm8921_led_info,
};


static struct pm8xxx_adc_amux m7c_pm8921_adc_channels_data[] = {
...
static struct pm8xxx_adc_properties m7c_pm8921_adc_data = {
	.adc_vdd_reference	= 1800, 
	.bitresolution		= 15,
	.bipolar                = 0,
};
static const struct pm8xxx_adc_map_pt m7c_adcmap_btm_table[] = {
	{-200,	1670},
	{-190,	1662},
	{-180,	1654},
	{-170,	1645},
...
static struct pm8xxx_adc_map_table pm8xxx_adcmap_btm_table = {
	.table = m7c_adcmap_btm_table,
	.size = ARRAY_SIZE(m7c_adcmap_btm_table),
};

static struct pm8xxx_adc_platform_data m7c_pm8921_adc_pdata = {
	.adc_channel		= m7c_pm8921_adc_channels_data,
	.adc_num_board_channel	= ARRAY_SIZE(m7c_pm8921_adc_channels_data),
	.adc_prop		= &m7c_pm8921_adc_data,
	.adc_mpp_base		= PM8921_MPP_PM_TO_SYS(1),
	.adc_map_btm_table	= &pm8xxx_adcmap_btm_table,
	.pm8xxx_adc_device_register	= m7c_pm8xxx_adc_device_register,
};

static struct pm8xxx_mpp_platform_data
m7c_pm8921_mpp_pdata __devinitdata = {
	.mpp_base	= PM8921_MPP_PM_TO_SYS(1),
};

static struct pm8xxx_gpio_platform_data
m7c_pm8921_gpio_pdata __devinitdata = {
	.gpio_base	= PM8921_GPIO_PM_TO_SYS(1),
};

static struct pm8xxx_irq_platform_data
m7c_pm8921_irq_pdata __devinitdata = {
...
static int m7c_pm8921_therm_mitigation[] = {
	1100,
	700,
	600,
	225,
...
pm8921_chg_pdata __devinitdata = {
	...
	.mbat_in_gpio		= 0, 
	.cable_in_irq       	= PM8921_GPIO_IRQ(PM8921_IRQ_BASE, OVP_INT_DECT),
	.cable_in_gpio       	= PM8921_GPIO_PM_TO_SYS(OVP_INT_DECT),
	.is_embeded_batt	= 1,
	.eoc_ibat_thre_ma	= 50,
	.ichg_threshold_ua = -1200000,
	.ichg_regulation_thr_ua 	= -375000,
	.thermal_mitigation	= m7c_pm8921_therm_mitigation,
	.thermal_levels		= ARRAY_SIZE(m7c_pm8921_therm_mitigation),
...
m7c_pm8921_platform_data __devinitdata = {
	.regulator_pdatas	= m7china_pm8921_regulator_pdata,
	.irq_pdata		= &m7c_pm8921_irq_pdata,
	.gpio_pdata		= &m7c_pm8921_gpio_pdata,
	.mpp_pdata		= &m7c_pm8921_mpp_pdata,
	.rtc_pdata		= &m7c_pm8921_rtc_pdata,
	.pwrkey_pdata	= &m7c_pm8921_pwrkey_pdata,
	.misc_pdata		= &m7c_pm8921_misc_pdata,
	.leds_pdata		= &m7c_pm8921_leds_pdata,
	.adc_pdata		= &m7c_pm8921_adc_pdata,
	.charger_pdata		= &pm8921_chg_pdata,
	.bms_pdata		= &pm8921_bms_pdata,
	.ccadc_pdata		= &m7c_pm8xxx_ccadc_pdata,
	.vibrator_pdata         = &pm8xxx_vib_pdata,
};

static struct pm8xxx_irq_platform_data
m7c_pm8821_irq_pdata __devinitdata = {
...
static struct pm8xxx_mpp_platform_data
m7c_pm8821_mpp_pdata __devinitdata = {
	.mpp_base	= PM8821_MPP_PM_TO_SYS(1),
};

static struct pm8821_platform_data
m7c_pm8821_platform_data __devinitdata = {
	.irq_pdata	= &m7c_pm8821_irq_pdata,
	.mpp_pdata	= &m7c_pm8821_mpp_pdata,
};

static struct msm_ssbi_platform_data m7c_ssbi_pm8921_pdata __devinitdata = {
	.controller_type = MSM_SBI_CTRL_PMIC_ARBITER,
	.slave	= {
		.name		= "pm8921-core",
		.platform_data	= &m7c_pm8921_platform_data,
	},
};

static struct msm_ssbi_platform_data m7c_ssbi_pm8821_pdata __devinitdata = {
	.controller_type = MSM_SBI_CTRL_PMIC_ARBITER,
	.slave	= {
		.name		= "pm8821-core",
		.platform_data	= &m7c_pm8821_platform_data,
	},
};

void __init m7c_init_pmic(void)
{
	if (system_rev == EVM) {
	...
	apq8064_device_ssbi_pmic1.dev.platform_data =
						&m7c_ssbi_pm8921_pdata;
	apq8064_device_ssbi_pmic2.dev.platform_data =
				&m7c_ssbi_pm8821_pdata;
	m7c_pm8921_platform_data.num_regulators =
					m7china_pm8921_regulator_pdata_len;

}

void __init m7c_init_pmic_register_cam_cb(void *cam_vcm_on_cb, void *cam_vcm_off_cb)
{
	if (cam_vcm_on_cb)
